...
export const searchWithAi = async (req, res) => {
    try {
        ...
        A user will type any query about what they want
        to learn. Your task is to understand the inten and 
        ...
        Only reply with one signle keyword from the list above that best
