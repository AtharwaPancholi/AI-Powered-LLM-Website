...
function ViewCourses() {
    ...
    useEffect(()=> {
        ...
        const handleCreator = async() => {
            ...
            try {
                const result = await axios.post(serverUrl + "/api/course/creator", {userId: selectedCourse?.creator}, 
    ...
    <div className='min-h-screen bg-gray-50 p-6'>
      ...
      rounded-xl p-6 space-y-6 relative'>
        <div className='flex flex-col md:flex-row gap-6'>
            ...
            <FaArrowLeftLong className='text-[black] w-[22px]
            h-[22px] cursor-pointer' onClick={()=>navigate("/")}/>
            {selectedCourse?.thumbnail ? <img src={selectedCourse?.thumbnail} alt='' className=' h-64 md:h-80 rounded-xl w-full object-cover' />: 
            <img src={img} alt='' className='h-64 md:h-80 rounded-xl w-full object-cover'/>}
            </div>
            ...
            <div className='flex-1 space-y-2 mt-[20px]'>
                ...
                justify-between'>
                    ...
                    <div>
                        ...
                        <span className='line-through text-sm text-gray-400'>$20</span>
                    </div>
                    ...
                    px-6 py-2 rounded hover:bg-green-400 mt-3 cursor-pointer' onClick={() => navigate(`/viewlecture/${courseId}`)}>Start</button>
                </div>
            </div>
        </div>
        ...
        <div>
            <h2 className='text-xl front-semibold mb-2'>Who This Course is For</h2>
            <p className='text-gray-700'>Beginners, aspiring developers, and 
        ...
        <div className='flex flex-col md:flex-row gap-6'>
            ...
            rounded-2xl shadow-lg border border-gray-200'>
                ...
                text-gray-800'>Course Curriculum</h2>
                ...
                <div className='flex flex-col gap-3'>
                    {selectedCourse?.lectures?.map((lecture, index)=>(
                        ...
                        py-3 rounded-lg border transition-all duration-200 text-left ${lecture.isPreviewFree ? 
                    "hover:bg-gray-100 cursor-pointer border-gray-300" : "cursor-not-allowed opacity-600 border-gray-200"}
            ...
            rounded-2xl shadow-lg border border-gray-200'>
                ...
                overflow-hidden mb-4 bg-black flex items-center
                justify-center'>
        ...
        <div className='mt-8 border-t pt-6'>
            ...
            <div className='mb-4'>
                ...
                value={comment} name='' className='w-full border
                border-gray-300 rounded-lg p-2'
                placeholder='Write your review here...' 
                rows={3}/>

                <button className='bg-black text-white mt-3
                px-4 py-2 rounded cursor-pointer hover:bg-gray-800' disabled={loading} onClick={handleReview}>{loading ? <ClipLoader size={30} color='white'/> : "Submit Review"}</button>
            </div>
        </div>
        ...
        border-t'>
            ...
            className='w-16 h-16 border-1 border-gray-200 rounded-full object-cover'/> :
            <img src={img} alt="" className='w-16 h-16 border-1 border-gray-200 rounded-full object-cover'/>}
            <div>
        ...
        <div className='w-full transition-all duration-300 py-[20px]
