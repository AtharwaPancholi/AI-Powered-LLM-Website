        ...
        items-center justify-center'>
          ...
          rounded-2xl flex' onSubmit={(e)=>e.preventDefault()}>
            ...
            items-center justify-center gap-3'>
                ...
                <h2 className='text-[#999797] text-[18px]'>Login into your account</h2>
                </div>
               ...
               onClick={()=>setShow(prev=>!prev)}/>
                ...
                cursor-pointer flex items-center justify-center rounded-[5px] cursor-pointer' disabled={loading} 
                ...
                rounded-[5px] flex items-center justify-center'>
                    ...
                    <span className='text-[18px] text-gray-500 cursor-pointer' onClick={googleLogin}>oogle</span>
                </div>
