  ...
  return (
    ...
    rounded-lg shadow-md'>
      ...
      md:justify-between flex-col md:flex-row mb-6 relative'>
        <FaArrowLeftLong className='top-[-20%] md:top-[20%]
        ...
        <div className='space-x-2 space-y-2'>
            ...
            rounded-md cursor-pointer' onClick={()=>navigate(`/createlecture/${selectedCourse?._id}`)}>
                Go to Lecture Page
            </button>
        </div>
      </div>
      ...
      <div className='bg-gray-50 p-6 rounded-md'>
        ...
        <div className='space-x-2 space-y-2'>
            ...
            rounded-md border-1 cursor-pointer' onClick={()=>setIsPublished(prev=>!prev)}>Click to Publish</button> :
            <button className='bg-red-100 text-red-600 px-4 py-2
            rounded-md border-1 cursor-pointer' onClick={()=>setIsPublished(prev=>!prev)}>Click to UnPublish</button>}
            <button className='bg-red-600 text-white px-4 py-2
            rounded-md cursor-pointer' onClick={handleRemoveCourse}>Remove Course</button>
        </div>
        <form className='space-y-6' onSubmit={(e)=>e.preventDefault()}>
            <div>
                ...
                px-4 py-2 rounded-md' placeholder='Course Title'
            ...
            <div>
                ...
                px-4 py-2 rounded-md' placeholder='Course Subtitle'
            ...
            <div className='flex gap-2'>
                <div className='flex-1'>
                    ...
                    <select name='' id='' className='w-full border px-4
                    py-2 rounded-md bg-white' onChange={(e)=>setCategory(e.target.value)} value={category}>
                ...
                <div className='flex-1'>
                    <label htmlFor='' className='block text-sm font-medium
                    text-gray-700 mb-1'>Course Level</label>
                    <select name='' id='' className='w-full border px-4
                    py-2 rounded-md bg-white' onChange={(e)=>setLevel(e.target.value)} value={level}>
                ...
                <div className='flex-1'>
                    ...
                    text-gray-700 mb-1'>Course Price (USD)</label>
            ...
            <div>
                ...
                font-medium text-gray-700 mb-1'>Course Thumbnail</label>
            ...
            h-[170px]'>
                ...
                h-[100%] border-1 border-black rounded-[5px] cursor-pointer' onClick={()=>thumb.current.click()}/>
                <FaEdit className='w-[20px] h-[20px] absolute top-2 right-2' onClick={()=>thumb.current.click()}/>
            </div>

            <div className='flex items-center justify-start gap-[15px]'>
                <button className='bg-[#e9e8e8] hover:bg-red-200
                text-black border-1 border-black cursor-pointer px-4 py-2
                rounded-md' onClick={()=>navigate("/courses")}>Cancel</button>
                <button className='bg-black text-white px-7 py-2
                rounded-md hover:bg-gray-500 cursor-pointer' onClick={handleEditCourse}>{loading ? <ClipLoader size={30}
