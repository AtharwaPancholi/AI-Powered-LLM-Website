    ...
    justify-center p-4'>
      ...
      shadow-lg p-6 space-y-6'>
        <div className='flex items-center gap-2 mb-2'>
            ...
            text-gray-800'>Update Course Lecture</h2>
        </div>

        <button className='mt-2 px-4 py-2 bg-red-600
        text-white rounded-md hover:bg-red-700 transition-all
        text-sm cursor-pointer' disabled={loading1} onClick={removeLecture}>{loading ? <ClipLoader size={30} color='white'/>:"Remove Lecture"}</button>
        ...
        <div className='space-y-4'>
            ...
            text-gray-700 mb-1' htmlFor=''>LectureTitle *</label>
                ...
                focus:ring-2 focus:ring-[black] focus:outline-none' type="text" required
            ...
            text-gray-700 mb-1' htmlFor=''>Video *</label>
                ...
                border-gray-300 rounded-md p-2 file:mr-4 file:py-2
                file:px-4 file:rounded-md file:border-0 file:text-sm file:bg-gray-700
                file:text-[white] hover:file:bg-gray-500' type="file" required accept='video/*'
        ...
        <div className='pt-4'>
            <button className='w-full cursor-pointer bg-black text-white py-3
            rounded-md text-sm font-medium hover:bg-gray-700
            transition' onClick={handleEditLecture}>{loading ? <ClipLoader size={30} color='white'/> : "Update Lecture"}</button>
        </div>
      </div>
    </div>
  )
