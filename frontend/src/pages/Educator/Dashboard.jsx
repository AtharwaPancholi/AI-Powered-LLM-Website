...
const Dashboard = () => {
    ...
    return (
        ...
        gap-6'>
                  ...
                  border-4 border-black shadow-md text-4xl font-bold">
                    ...
                    <div className='text-center md:text-left space-y-1'>
                        ...
                        <p className='text-gray-600 text-sm'>{userData?.description 
                            || "Start creating courses for your students"}</p>
                        <h1 className='px-[10px] text-center py-[10px]
                        border-2 bg-black border-black text-white rounded-[10px]
                        text-[15px] font-light flex items-center justify-center 
                        cursor-pointer' onClick={()=>navigate("/courses")}>Create Courses</h1>
                    </div>
                </div>
