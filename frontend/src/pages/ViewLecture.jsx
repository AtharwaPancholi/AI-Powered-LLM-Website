    ...
    md:flex-row gap-6'>
      ...
      shadow-md p-6 border border-gray-200'>
        ...
        <div className='mb-6'>
            ...
            justify-start gap-[20px] text-gray-800'><FaArrowLeftLong className='text-black
       ...
       <div className='mt-2'>
        <h2 className='text-xl font-semibold text-gray-800'>
            {selectedLecture?.lectureTitle}</h2>
        </div> 
      </div>
      ...
      shadow-md p-6 border border-gray-200 h-fit'>
            ...
            {selectedCourse?.lectures?.length > 0 ?
             (selectedCourse?.lectures?.map((lecture, index)=> (
                ...
                className={`flex items-center justify-between p-3 rounded-lg
                    ...
                    ? 'bg-gray-200 border-gray-500' : 'hover:bg-gray-50 border-gray-300'}`}><h2 className='
                    text-sm font-semibold text-gray-800'>{lecture.lectureTitle}</h2>
                    <FaPlayCircle className='text-lg text-black'/></button>
             ))) : 
       ...
       {creatorData &&  <div className='mt-4 border-t pt-4'>
        ...
        className='w-14 h-14 rounded-full object-cover'/></div>
        <div>
            <h2 className='text-base font-medium
            text-gray-800'>{creatorData?.name}</h2>
